...
import { imageMeta, imageSources } from "@/lib/images";
...
export function SmartImage({
  ...
  return (
    ...
    >
      {/* AVIF first, then WebP, then the original JPEG — first match wins.
          Across this site's photographs AVIF is ~57% smaller than the JPEG and
          WebP ~21%, and a browser that understands neither still gets a photo.

          The <img> underneath is unchanged, which is the important part: it
          keeps the width/height that give this site its zero CLS, the blur
          placeholder, the fade and the boot-gate hold. <picture> only chooses
          which bytes that <img> loads.

          Generated by scripts/optimize-images.mjs. Open Graph images are
          deliberately excluded from this — see the note in that script. */}
      <picture>
