...
export const body: ArticleBody = [
  ...
  {
    t: "cta",
    text: "Workplace English practises calls, clarification, status updates, professional messages and presentations in a live batch capped at 6. Bring one real support or client scenario to the ₹0 demo and judge the correction for yourself.",
