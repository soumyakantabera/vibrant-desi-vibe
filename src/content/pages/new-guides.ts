...
export const NEW_GUIDE_VIEWS: Record<string, GuideView> = {
  ...
  "/how-to-speak-english-fluently": {
    ...
    ctaBody: "If you already have a partner and a map, stay free. If you need a teacher who remembers your errors, sit in a demo.",
  ...
  "/spoken-english-for-homemakers-india": {
    ...
    waMessage: "Hi, I am a homemaker and I would like a Spoken English demo in a daytime batch.",
    ctaTitle: "Join a daytime or weekend batch",
    ctaBody: "Tell us your window. We reply 09:00–12:00 IST. The demo is free.",
  ...
  "/online-vs-offline-spoken-english-classes": {
    ...
    ctaBody: "Count your own minutes in a demo. If a neighbourhood room fits you better, we will say so.",
  ...
  "/free-english-speaking-practice-vs-paid-class": {
    ...
    body: [
      ...
      {
        t: "p",
        text: "Run the free stack for two weeks. If you skipped more than four days, or you cannot name what improved, a live seat is probably cheaper than another year of podcasts. Sit in a demo and count your own minutes before you pay.",
      },
      {
        t: "cta",
        text: "If free is enough, we will say so. If it is not, the demo is still free.",
        course: "/book-free-demo",
        label: "Book a Free Demo",
      },
    ],
