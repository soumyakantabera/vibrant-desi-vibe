...
function Page() {
  return (
    <Layout waMessage="Hi, I read About Us and I want a free consultation." footerImage={IMG.team}>
      ...
      <section className="section">
        <div className="container-x text-center">
          ...
          <div className="mt-6 flex flex-wrap gap-3 justify-center">
            <WaButton
              message="Hi, I read About Us and I want a free consultation."
              variant="sun"
              size="lg"
            >
              Get Free Consultation
            </WaButton>
            <WaButton message="Hi, I want a free consultation to choose my course." variant="wa" size="lg">
              Chat on WhatsApp
            </WaButton>
          </div>
        </div>
