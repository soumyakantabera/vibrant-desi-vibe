  ...
  return (
    <Layout waMessage="Hi, I'd like to know why Learn With Smile fits me. Free demo please." footerImage={IMG.liveClass}>
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 z-0"><SmartImage src={IMG.liveClass} alt="Small online class of six students with the teacher on screen" fill priority sizes="100vw"/><div className="absolute inset-0 bg-gradient-to-br from-ink/85 via-brand-deep/80 to-coral/40"/></div>
      ...
      <section className="section bg-brand-deep">
        <div className="container-x grid lg:grid-cols-[1fr_1.2fr] gap-10 items-center">
          <SmartImage src={IMG.womanLaptop} alt="Teacher giving live feedback during an online English class" className="rounded-3xl shadow-2xl h-[360px] w-full" sizes="(min-width: 1024px) 45vw, 100vw"/>
