      ...
      <section className="relative">
        ...
        <div className="container-x py-16 md:py-24 text-cream max-w-3xl">
          ...
          <p className="mt-5 text-lg text-white">
            Fill four quick details — we confirm your demo slot on WhatsApp in minutes.
          </p>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container-x grid lg:grid-cols-[1fr_1fr] gap-10 items-start">
          <div className="card-soft">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs text-ink/85 text-center">
                No spam. We only message you about your free demo and class details.
              </p>
            </div>
          </div>
          <div className="space-y-5">
            ...
            <WaButton
              message="Hi, I'd like to talk before filling the form. Please call me back."
              variant="primary"
            >
              Prefer to chat first? Message us
            </WaButton>
          </div>
        </div>
      </section>
