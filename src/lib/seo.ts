...
export const COURSE_SEO: Record<string, CourseSeoExtra> = {
  ...
  "business-english": {
    title: "Business English Online | ₹1,500/mo, 3 Months",
    description:
      "Business English for working professionals — emails, meetings, presentations and negotiation. Live online for 3 months, max 6 students, ₹1,500/month.",
    ...
    summary:
      "Business English — ₹1,500/month · 3 months in a live batch of max 6. Emails, meetings, presentations and negotiation.",
    extraFaqs: [
      {
      ...
      },
      {
        ...
        a: "Yes. Learn With Smile runs early-morning, evening and weekend batches on IST specifically for working professionals. The three-month course is ₹1,500/month; every class is recorded so a missed session because of a work escalation does not set you back.",
      },
    ],
  },
